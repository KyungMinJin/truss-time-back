...
<div id="wrapper">
	...
	?>
	<form action=<?php echo "'deldel.php?teamname=".$teamname."'" ?> method="post" enctype="multipart/form-data" />
	<table class="table table-bordered" style="width:30%; margin:0 auto;">
	<tr><td class="danger" style="text-align: center;">정말 삭제하시겠습니까?</td></tr>
	<tr><td style="text-align: center;">관리용 비밀번호: <input type="password" name="teampw" size="30" style="ime-mode:disabled;"></td></tr>
	<tr><td style="text-align: center;">TRUSS 인증번호: <input type="password" name="truss_ck" size="30" style="ime-mode:disabled;"></td></tr>
	<tr><td style="text-align: center;"><input type="submit" name="b_insert" value="삭제" style="width:50px">
        <button type="button" onclick="location.href=<?php echo '\'search.php?teamname='.$teamname.'\''; ?>" style="width:50px">취소</button></td></tr>
	</table>
	</form>
