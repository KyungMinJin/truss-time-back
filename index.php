        ...
        <div id="portfolio" class="container">
            <h1 class="icon icon-tasks" align="center"> 주요 행사</h2>
                ...
                <div id="column1">
                    ...
                    <p>신입생이 바글거릴 3월 말즈음 고학번 선배까지 불러모아서 신입생과 술을 마시는 행사이다. 뭐 대단한건 아니고 일종의 대면식이라고 봐도 된다. 커팅이 시작되기 전 선배들에게
                        얼굴 도장 찍을 몇 안 되는 기회다.</p>
                    <p>신환회가 끝나고 4월 초중순 즈음 우이동에서 진행한다. 말 그대로 MT. 총MT만의 특징이라면 MT주제에 고학번 선배들까지 바글바글 온다는 점과 '오배주'를 들 수 있다.
                        기장 및 부기장 즉, 감투를 쓴자들은 후술할 기장선거 MT에서 오배주의 업그레이드 버전인 십(十)배주를 마시게 된다. </p>
                ...
                <div id="column2">
                    ...
                    <p>5월즈음 해서 여는 행사로 캠퍼스 길바닥에서 하는 타 과 및 타 동아리와 다르게 건물을 빌려다 한다. 마침 안암오거리에 적절한 건물이 있어 매년 그 곳을 애용한다. 창렬푸드를
                        주로 팔며 공연도 같이 한다.</p>
                    <a href="#" class="icon icon-arrow-right button">Read More</a>
                </div>
                <div id="column3">
                    ...
                    <p>주점이 끝나고나면 10월말 또는 11월 초에 있을 정기공연에 대비하여 정기공연 팀을 편성하고 합주를 진행하게 된다. 그러다 여름방학이 끝나가고 개강이 다가올 무렵 (주로 8월
                        중~말) 고려대학교 대천수련원에 가서 3박4일 합숙훈련을 한다.</p>
                    <p>매년 10월 말 또는 11월 초에 418 기념관에서 1년차 신입과 2년차 현역들로 구성된 팀들과 5년차 OB팀으로 구성된 공연을 한다.입장료는 무료다. 친구 중에 트러스를
                        하는 친구가 있다면 이건 꼭 가서 봐주도록 하자.</p>
                    <a href="#" class="icon icon-arrow-right button">Read More</a>
                </div>
                <div id="column4">
                    <div class="title">
                    ...
                    <p>일년 행사 중 현역이 주관하는 마지막 행사이다. 워크샵부터 정기공연까지 무사히 살아남아서 다음 해의 현역이 될 신입생들의 일년 간의 행적을 기반으로 그 기수의 대표인 기장을
                        뽑는 중요한 자리이다. 기장의 성격에 따라 그 다음 신입생들의 성향이나 소규모공연을 끌어오는 빈도 등이 달라지기 때문에 평소에는 좀 제정신이 아닌 것 같이 살던 사람도 이
                        날 만큼은 정상인의 스펙트럼에 가까워진다. </p>
                    <a href="#" class="icon icon-arrow-right button">Read More</a>
                </div>
        </div>
    </div>
