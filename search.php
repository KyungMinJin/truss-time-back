...
?>
            ...
            <div id="header" class="container" style="width:70%">
                <!-- style="width:100%; margin:0 auto;">-->
                <p style="text-align:left; float:left;"><a style="text-align:left; color:red;"
                        onclick="window.history.go(-1); return false;" href="timetable.php">돌아가기</a></p>
                <p style="text-align:right; float:right"><a style="text-align:right; color:red;"
                        href=<?php echo '"edit.php?teamname='.$teamname.'"'; ?>>합주팀 관리</a> / <a
                        style="text-align:right; color:red;"
                        href=<?php echo '"delete.php?teamname='.$teamname.'"'; ?>>합주팀 삭제</a></p>
                <?php
...
?>
	...
	?>
                    ...
                    <tr>
                        <td style="width:20%" class="danger" align="right">보컬</td>
                        <td align="left"><?php $findphone = $result['vocal']; echo $result['vocal']; ?></td>
	...
	?>
                    ...
                    <tr>
                        <td style="width:20%" class="danger" align="right">퍼스트기타</td>
                        <td align="left"><?php $findphone = $result['first']; echo $result['first']; ?></td>
	...
	?>
                    ...
                    <tr>
                        <td style="width:20%" class="danger" align="right">세컨드기타</td>
                        <td align="left"><?php $findphone = $result['second']; echo $result['second']; ?></td>
                        <?php // find phone number
	if($show){
		echo '<td style="width:30%">';
		$query = "SELECT * FROM phone WHERE name='$findphone'";
	...
	?>
                    ...
                    <tr>
                        <td style="width:20%" class="danger" align="right">베이스기타</td>
                        <td align="left"><?php $findphone = $result['bass']; echo $result['bass']; ?></td>
                        <?php // find phone number
	if($show){
		echo '<td style="width:30%">';
		$query = "SELECT * FROM phone WHERE name='$findphone'";
	...
	?>
                    ...
                    <tr>
                        <td style="width:20%" class="danger" align="right">드럼</td>
                        <td align="left"><?php $findphone = $result['drum']; echo $result['drum']; ?></td>
	...
	?>
                    ...
                    <tr>
                        <td style="width:20%" class="danger" align="right">키보드</td>
                        <td align="left"><?php $findphone = $result['keyboard']; echo $result['keyboard']; ?></td>
...
?>
                ...
                <br>
                <form action=<?php echo '"reply.php?teamname='.$teamname.'&no='.$realno.'"'; ?> method="post"
                ...
                <table class="table table-bordered table-hover" style="width:70%; margin:0 auto;">
                    ...
                    <tr>
                        <td>이름: <input type="text" name="writer" style="width:15%"> 내용: <input type="text"
                                name="content" style="width:65%"> <input type="submit" name="b_insert" value="등록"
                                style="width:50px"></td>
                    </tr>
                </table>
                </form>
