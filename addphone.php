...
<tr class="danger">
	<td style="width:20%">기수</td><td style="width:25%">이름</td><td>연락처</td>
</tr>
<?php
	for($i=0;$i<10;$i++){
...
?>
<tr>
	<td colspan="3">TRUSS 인증 비밀번호: <input type="password" name="truss_ck" size="30" style="ime-mode:disabled;"><input type="submit" name="b_insert" value="등록" style="width:50px">
        <button type="button" onclick="window.history.go(-1); return false;" style="width:50px">취소</button></td>
</tr>
</table>
</form>
<script>
