...
<tr>
	<td class="danger" align="right">팀 이름(필수)</td><td align="left"><input type="text" name="teamname" size="30" value =<?php echo '"'.$teamname.'"'; ?>>
	  임시팀 여부 <?php
...
<tr>
	<td class="danger" align="right">기존 비밀번호<br>합주팀 관리/삭제용</td><td align="left"><input type="password" name="pw_old" size="30" style="ime-mode:disabled;"></td>
</tr>
<tr>
	<td class="danger" align="right">새로운 비밀번호(선택)</td><td align="left"><input type="password" name="teampw" size="30" style="ime-mode:disabled;">    비밀번호 확인: <input type="password" name="teampw2" size="30" style="ime-mode:disabled;"></td>
</tr>
<tr>
	<td class="danger" align="right">보컬</td><td align="left"><input type="text" name="vocal" size="30" value=<?php echo '"'.$vocal.'"'; ?>></td>
	<!--<td align="left"><textarea name="memo" cols="60" rows="10"></textarea></td>-->
</tr>
<tr>
	<td class="danger" align="right">퍼스트기타</td><td align="left"><input type="text" name="first" size="30" value=<?php echo '"'.$first.'"'; ?>></td>
	<!--<td align="right">첨부파일</td><td align="left"><input type="file" name="upfile"></td>-->
</tr>
<tr>
	<td class="danger" align="right">세컨드기타</td><td align="left"><input type="text" name="second" size="30" value=<?php echo '"'.$second.'"'; ?>></td>
</tr>
<tr>
	<td class="danger" align="right">베이스기타</td><td align="left"><input type="text" name="bass" size="30" value=<?php echo '"'.$bass.'"'; ?>></td>
</tr>
<tr>
	<td class="danger" align="right">드럼</td><td align="left"><input type="text" name="drum" size="30" value=<?php echo '"'.$drum.'"'; ?>></td>
</tr>
<tr>
	<td class="danger" align="right">키보드</td><td align="left"><input type="text" name="keyboard" size="30" value=<?php echo '"'.$keyboard.'"'; ?>></td>
</tr>
<tr>
...
<tr>
	<td colspan="2">TRUSS 인증 비밀번호: <input type="password" name="truss_ck" size="30" style="ime-mode:disabled;"><input type="submit" name="b_insert" value="등록" style="width:50px">
        <button type="button" onclick="location.href='timetable.php'" style="width:50px">취소</button></td>
</tr>
</table>
</form>
